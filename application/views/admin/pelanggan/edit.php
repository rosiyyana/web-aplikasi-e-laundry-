...
<div class="row">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" name="email" class="form-control" value="<?php echo $pelanggan->email ?>" readonlye>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <select name="level" class="form-control">
              <!-- <option value="Admin" <?php if ($pelanggan->level=="Admin") { echo "selected"; } ?>>Admin</option>
              <option value="Admin" <?php if ($pelanggan->level=="Admin") { echo "selected"; } ?>>Petugas</option> -->
              <option value="pelanggan" <?php if ($pelanggan->level=="pelanggan") { echo "selected"; } ?>>pelanggan</option>
            </select>
        </div>
    </div>
    <div class="col-sm-12">
