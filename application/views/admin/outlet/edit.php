...
// return open
echo form_open_multipart(base_url('admin/outlet/edit/'.$outlet->id_outlet), ' class="form-horizontal"');
?>
...
<div class="row">
    <div class="col-sm-6">
        <div class="form-group">
            ...
            <input type="text" name="nama_outlet" class="form-control" value="<?php echo $outlet->nama_outlet ?>" required>
        </div>
    </div>
