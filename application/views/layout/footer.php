...
?>
	<!-- Footer -->
	<footer class="bg5 p-t-10 p-b-10 p-l-45 p-r-45" style="background : #e3f6f5">
		<div class="flex-w p-b-90">
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					<li class="p-b-9">
						<a href="#" class="s-text7">
						Taruna Bhakti Vocational High School 
						</a>
					</li>
			...
			<div class="w-size8 p-t-30 p-l-15 p-r-15 respon3">
				...
				<form>
					...
					<div class="w-size2 p-t-20 float-right">
						<!-- Button -->
		...
		<div class="t-left p-l-15 p-r-15">
			<div class="t-center s-text8 p-t-10 p-b-10">
				© 2021 Pay Laundry Online | Bootstrap Wordpress Theme
			</div>
		</div>
	</footer>
	...
	<script>
		$(document).ready(function () {
			$("#about").click(function() {
                $("html, body").animate({
                    scrollTop: $("#target-about").offset().top
                }, 1000)
            });
		});
	</script>
